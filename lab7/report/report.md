...
subtitle: "Создание диаграммы состояний"
...
header-includes:
  - \usepackage{fancyhdr}
  - \pagestyle{fancy}
  - \fancyhead[L]{Практическая работа № 8}
  - \fancyhead[R]{Грибков А.}
  - \usepackage{float}
...
![Диаграмма состояний заказа аренды в системе SportRent](../solutions/diagrams/state-diagram.png){ width=100% }
